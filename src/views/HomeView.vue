<script setup>
    ...
    const cmd1 = () => {
        requestData.post("https://iot-api.heclouds.com/datapoint/synccmds", {
            command: data.light_icon ? "0x00" : "0x01",
        }, {
            params: {
                product_id: "Hn5sqb3tOh",
                device_name: "monitor",
    ...
    const cmd2 = () => {
        requestData.post("https://iot-api.heclouds.com/datapoint/synccmds", {
            command: data.fan_icon ? "0x10" : "0x11",
        }, {
            params: {
                product_id: "Hn5sqb3tOh",
                device_name: "monitor",
        ...
        <div class="dataBody" style="background: linear-gradient(to top, #ffffff, #6dd5fa, #2980b9);">
            ...
            <div class="valueBody" style="margin: 20px">
                ...
                <div>
                    ...
                    <span style="font-family: 微软雅黑,serif;margin: 7px">{{ data.wifi }}</span>
                </div>
            </div>
            <div class="valueBody" style="margin: 20px">
                灯光状态
                <div>
                    <div v-if="data.monitor.lightStat" style="position: fixed;margin: 5px 0 0 50px">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                            <path fill="#ffef0f"
                    ...
                    <!--                    <span style="font-family: 微软雅黑,serif;padding: 0 20px 0 20px;">{{ data.monitor["lightStat"] }}</span>-->
                    <el-switch v-model="data.monitor.lightStat"
                               style="--el-switch-on-color: #13ce66; --el-switch-off-color: #999999;margin-left: 30px;font-family: 微软雅黑,serif"
                               active-text="ON" inactive-text="OFF" inline-prompt size="large"
                               :loading="loading1" :before-change="beforeChange1"></el-switch>
                </div>
            </div>
            <div class="valueBody" style="margin: 20px">
                风扇状态
                <div>
                    <div v-if="data.monitor.fanStat" style="position: fixed;margin: 5px 0 0 50px">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                            <path fill="#55acd8"
                    ...
                    <el-switch v-model="data.monitor.fanStat"
                               style="--el-switch-on-color: #13ce66; --el-switch-off-color: #999999;margin-left: 30px;font-family: 微软雅黑,serif"
                               active-text="ON" inactive-text="OFF" inline-prompt size="large"
                               :loading="loading2" :before-change="beforeChange2"></el-switch>
